...
const Support = () => {
    return (
        <section id="support" className='my-16 md:mx-28 mx-12 mx-auto scroll-m-20'>
            ...
            <h3 className='text-5xl font-extrabold text-center my-4 py-4 text-transparent bg-clip-text bg-gradient-to-br from-pink-500 to-yellow-500 border-b-2 '>GOLD SPONSORS</h3>
            ...
            <h3 className='text-4xl font-bold text-center my-4 py-4 text-transparent bg-clip-text bg-gradient-to-br from-blue-500 to-silver-500 border-b-2 '>SILVER SPONSORS</h3>
            ...
            <h3 className='text-3xl font-bold text-center my-4 py-4  text-transparent bg-clip-text bg-gradient-to-br from-gray-500 to-orange-500 border-b-2 '>BRONZE SPONSORS</h3>
