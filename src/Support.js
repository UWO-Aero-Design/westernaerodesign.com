...
const Support = () => {
    return (
        <section id="support" className='my-16 md:mx-28 mx-12 mx-auto scroll-m-20'>
            <h1 className='text-center pb-5 mb-10 border-b-2 font-bold text-4xl'>Donors</h1>
            <div>
            <h2 className='font-medium text-2xl'>Interested in becoming a donor?</h2> 
            <p className='py-3 text-lg'>
                Feel free to take a look at our <a download="Sponsorship Package" className='font-medium text-purple-700 hover:text-purple-500 transition-all duration-300' href={SponsorshipPackage}> donation package </a> and send us an email at <a className='font-medium text-purple-700 hover:text-purple-500 transition-all duration-300' href="mailto:western.aerodesign.com">western.aerodesign@gmail.com</a>. 
                We look forward to working with you!
            </p>
            </div>
            <h3 className='text-5xl font-extrabold text-center my-4 py-4 text-transparent bg-clip-text bg-gradient-to-br from-pink-500 to-yellow-500 border-b-2 '>GOLD DONORS</h3>
            ...
            <h3 className='text-4xl font-bold text-center my-4 py-4 text-transparent bg-clip-text bg-gradient-to-br from-blue-500 to-silver-500 border-b-2 '>SILVER DONORS</h3>
            <div className="grid place-items-center grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <a href="https://lmac.ca/"><img className='my-2 px-12 hover:-translate-y-1 hover:scale-110 duration-300' src={RC} alt='London Model Aircraft Club'></img></a>
            ...
            <h3 className='text-3xl font-bold text-center my-4 py-4  text-transparent bg-clip-text bg-gradient-to-br from-gray-500 to-orange-500 border-b-2 '>BRONZE DONORS</h3>
